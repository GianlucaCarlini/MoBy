...
training_config = OmegaConf.load("configs/config_ssl_2d.yaml")

swin_config = Swinv2Config(
    image_size=256, patch_size=4, window_size=8, initializer_range=1.0
)

encoder = Swinv2Model(swin_config)
encoder_k = Swinv2Model(swin_config)
...
wandblogger = WandbLogger(project="MoBY", name="MoBy_2D")
